    ...
    <div class="detail-content">
      <div class="detail-content-top">
        ...
        <div class="top-right">
          ...
          <div class="meta">设施：{{ detailData.sheshi }}</div>
          <div class="meta">是否有窗：{{ detailData.sfyc }}</div>
          <div class="meta">有无早餐：{{ detailData.zaocan }}</div>
          <div class="meta">地址：{{ detailData.address }}</div>
          <div class="actions">
