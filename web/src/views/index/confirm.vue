  ...
  <div>
    ...
    <section class="cart-page flex-view">
      <div class="left-flex">
        ...
        <a-range-picker v-model:value="pageData.receiverDate" :locale="locale" @change="onChange()" style="margin-top:16px;"/>
      ...
      <div class="right-flex">
        ...
        <div class="price-view">
          <div class="price-item flex-view">
            <div class="item-name">客房总价</div>
            <div class="price-txt">¥{{ pageData.amount }}</div>
          </div>
          <div class="price-item flex-view">
            <div class="item-name">客房优惠</div>
            <div class="price-txt">¥0</div>
          </div>
          <div class="price-item flex-view">
            <div class="item-name">客房折扣</div>
            <div class="price-txt">¥0</div>
          </div>
...
<script setup>
  ...
  // 天数
  const onChange = () => {
    let start = pageData.receiverDate[0];
    let end = pageData.receiverDate[1];
    let diff = end.diff(start, 'day');
    pageData.count = diff;
    pageData.amount = pageData.price * diff;
  };
  ...
  const handleCommit = () => {
    ...
    formData.append('receiverDate', pageData.receiverDate[0].format('YYYY-MM-DD') + '至' + pageData.receiverDate[1].format('YYYY-MM-DD') || '');
