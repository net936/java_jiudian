      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="客房名称" name="title">
                  <a-input placeholder="请输入" v-model:value="modal.form.title" />
                </a-form-item>
              </a-col>
              <a-col span="24">
                <a-form-item label="房型分类" name="classificationId">
                  <a-select
                    placeholder="请选择"
                    allowClear
                    :options="modal.cData"
              ...
              <a-col span="12">
                <a-form-item label="设施">
                  <a-input placeholder="请输入" v-model:value="modal.form.sheshi" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="是否有窗">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.sfyc">
              ...
              <a-col span="12">
                <a-form-item label="早餐">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.zaocan">
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('sfyc', modal.form.sfyc || '');
        formData.append('zaocan', modal.form.zaocan || '');
